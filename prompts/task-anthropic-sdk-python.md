# Analyze ALL Open anthropic-sdk-python Issues

## Objective
Create a comprehensive analysis of ALL open issues in the anthropic-sdk-python repository.
...
## Output
Save report to: `./workspace/anthropic-sdk-python-issue-report.md`
...
- Save raw data to `./workspace/anthropic-sdk-python-issues.json` for reference
